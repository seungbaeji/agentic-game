...
exploration, quest, dialogue, skill_training은 아직 이 runner를 사용하지 않습니다. 이 경계는 의도적으로 좁게 유지되어 있습니다. scenario flow와 graph shape 일반화가 먼저이며, tool/usecase/game state 일반화는 필요한 시나리오부터 확장합니다.
